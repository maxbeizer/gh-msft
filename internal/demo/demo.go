...
func (MailProvider) ListInbox(_ context.Context, top int, _ bool) ([]mail.Message, error) {
	messages := []mail.Message{
		...
		demoMail("demo-newsletter", "August engineering news", "Contoso Newsletter", "newsletter@example.test", "2026-08-01T09:15:00Z", true),
		demoMail("demo-duck", "Fwd: the rubber duck has opinions", "Morgan Lee", "morgan@example.test", "2026-08-01T08:52:00Z", true),
